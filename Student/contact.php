...
<section class="contact" id="contact">
  ...
  <div class="container pt-3">
    <div class="row">
      ...
      <form action="Student/sendemail.php" method="POST">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <button type="submit" class="btn px-3 " style="border-radius:50px" name="submitMail"><i class='fas fa-location-arrow'></i>&nbsp;Submit</button>
